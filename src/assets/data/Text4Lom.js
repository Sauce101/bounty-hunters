  ...
  return (
    <div className="w-full">
      <p className="text-base font-normal leading-normal mb-4 text-slate-900">
        ...
        where he served as a translator between the vessel&apos;s wealthy
        passengers and its computer. He found this work to be mundane and
        undemanding, and after the Kuari Princess&apos;s computer altered his
        programming, 4-LOM began to steal from the passengers. Eventually, he
        left the Kuari Princess for good, becoming an expert thief, information
      ...
      <p className="text-base font-normal leading-normal mb-4 text-slate-900">
        ...
        created to serve, the sentient Gand. Due to Cybot Galactica&apos;s hold
        over the protocol droid market with their 3PO-series, the LOM-series was
